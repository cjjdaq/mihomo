...
type BaseOption struct {
	...
	PoolPort     bool   `inbound:"pool-port,omitempty"`
...
// SpecialProxy returns the bound proxy name of this inbound ("" if none).
func (b *Base) SpecialProxy() string {
	if b.config == nil {
		return ""
	}
	return b.config.SpecialProxy
}

// PoolPort reports whether this inbound was auto-generated by proxy-port-pool.
func (b *Base) PoolPort() bool {
	if b.config == nil {
		return false
	}
	return b.config.PoolPort
}
