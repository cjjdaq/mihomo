...
const (
	...
	baseAlphaURL    = "https://github.com/cjjdaq/mihomo/releases/download/Prerelease-Alpha/"
	versionAlphaURL = "https://github.com/cjjdaq/mihomo/releases/download/Prerelease-Alpha/version.txt"
